...
export const ContextDetailsStep = ({
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Header Container */}
      <div className="flex flex-col md:flex-row md:items-start gap-1 mb-8 md:mb-12">
        ...
        <div className="mt-4 md:mt-0 md:ml-4">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-brand-brown mb-4 tracking-tight">Context matters.</h1>
