              ...
              <div className="space-y-4 mb-8">
               ...
               <div className="relative mb-8">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-widest px-4">
                  <span className="bg-white text-brand-text-muted px-2">Or with email</span>
                </div>
              </div>
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-brand-cream flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-3xl font-serif font-bold text-brand-brown animate-pulse">Sandy is waiting...</h2>
      </div>
    }>
      <SignupContent />
    </Suspense>
