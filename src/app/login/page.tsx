            ...
            <div className="relative">
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-widest px-4">
                  <span className="bg-white text-brand-text-muted px-2">Or continue with</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <Button 
                  variant="ghost" 
                  size="xl" 
                  className="w-full shadow-sm flex items-center justify-center gap-3 bg-[#F2F4F7] hover:bg-[#E3E5E8] text-[#1F1F1F] font-semibold normal-case tracking-normal rounded-full border-none transition-colors duration-200"
                ...
                >
                  <svg className="w-5 h-5 text-black" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.35-1.09-.56-2.09-.48-3.24.05-1.44.67-2.2.53-3.1-.48C3.79 16.27 3.51 7.26 9.5 7.03c1.55.06 2.65.64 3.5 1.18 1.45.92 2.37.58 3.5-.06 1.83-1.03 4.41-.53 5.56 1.25-4.8 2.4-3.9 9.3 1.05 11.23-.58 1.4-1.35 2.76-2.46 3.93l-3.6 4.72zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
                  </svg>
                  Continue with Apple
                </Button>
              </div>
